...
VALUES
    ...
    ('Tuyển dụng Sales bán bất động sản',
     'https://raw.githubusercontent.com/quangbm0807/static-assets/main/banner/3.webp',
     true,
     'SAIGONLAND',
     20,
     NOW(),
    ...
    ('Tuyển dụng thợ xây dựng, lao động phổ thông',
     'https://raw.githubusercontent.com/quangbm0807/static-assets/main/banner/4.webp',
     true,
    ...
    ('Tuyển dụng truyền thông và marketing',
     'https://raw.githubusercontent.com/quangbm0807/static-assets/main/banner/5.webp',
     true,
     'MTD Group',
     25,
     NOW(),
